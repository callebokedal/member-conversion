...
def compare_mc_and_io(mc_file_name, io_file_name):
    ...
    def print_io_group_stats(label, df , extra = None):
        if extra:
    ...
    print_io_group_stats('Styrelse SFK', io_read_df)
    print_io_group_stats('Senior', io_read_df)
    print_io_group_stats('Sektion Innebandy', io_read_df)
    print_io_group_stats('Sektion MTB', io_read_df)
    print_io_group_stats('MC_Cirkusledarutbildning', io_read_df)
    print_io_group_stats('MC_Fotboll', io_read_df)
    print_io_group_stats('MC_FrisksportlöfteJa', io_read_df)
    print_io_group_stats('MC_FrisksportlöfteNej', io_read_df)
    print_io_group_stats('MC_FrisksportutbildningBasic', io_read_df)
    print_io_group_stats('MC_FrisksportutbildningSteg1', io_read_df)
    print_io_group_stats('MC_GruppViaMC', io_read_df, "Ignorera")
    print_io_group_stats('MC_Hedersmedlem', io_read_df)
    print_io_group_stats('MC_Huvudsektion', io_read_df)
    print_io_group_stats('MC_Import', io_read_df)
    print_io_group_stats('MC_IngenTidning', io_read_df)
    print_io_group_stats('MC_Innebandy', io_read_df)
    print_io_group_stats('MC_Medlemmar', io_read_df, "Ignorera. Tas bort?")
    print_io_group_stats('MC_Medlemsavgift_2020', io_read_df)
    print_io_group_stats('MC_MTB', io_read_df)
    print_io_group_stats('MC_OfullstPnr', io_read_df, "Ignorera")
    print_io_group_stats('MC_OL', io_read_df)
    print_io_group_stats('MC_SACRO', io_read_df)
    print_io_group_stats('MC_Skate', io_read_df)
    print_io_group_stats('MC_Skidor', io_read_df)
    print_io_group_stats('MC_TrampolinutbildningSteg1', io_read_df)
    print_io_group_stats('MC_TrampolinutbildningSteg2', io_read_df)
    print_io_group_stats('MC_Uppdaterad', io_read_df, "Ignorera")
    print_io_group_stats('MC_Volleyboll', io_read_df)
